    ...
    return (
        <>
            <div className='m-0' style={{ color: "white", textAlign: 'justify' }}>
                ...
                <div className='px-3 pt-3' style={{textAlign:'left'}}>Long and Cumbersome URL - https://images.pexels.com/photos/2071882/pexels-photo-2071882.jpeg?cs=srgb&dl=pexels-wojciech-kumpicki-2071882.jpg&fm=jpg</div>
                <div className='px-3 pt-1 pb-2'>Shrinked URL - balibabu.github.io/myapp#/a/1</div>
            </div>
        </>
    )
}
